      ...
      <div className="container-custom">
        <div className="bg-card rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-card border border-border">
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
            {/* Icon */}
            <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-2 sm:space-y-3 text-muted-foreground text-xs sm:text-sm leading-relaxed">
                <p>
                ...
                <div className="flex items-start gap-2 pt-1 sm:pt-2">
                  <Trash2 className="w-4 h-4 sm:w-5 sm:h-5 text-accent flex-shrink-0 mt-0.5" />
                  <p>
