...
const vehicles: Vehicle[] = [
  {
    ...
    image: vehicleImage,
    badge: "Oportunidade",
    tags: ["Entrada a partir de 30%", "Parcelas Flexíveis"],
  },
  {
    id: 2,
    name: "VOLKSWAGEN GOL",
    model: "1.0 MPI Trendline",
    year: "2015",
    fuel: "Flex",
    km: "75.000 km",
    price: "R$ 32.900",
    image: vehicleImage,
    badge: "Destaque",
    tags: ["IPVA Pago", "Parcelas Flexíveis"],
  },
  {
    id: 3,
    name: "FIAT UNO",
    model: "Vivace 1.0 Flex",
    year: "2018",
    fuel: "Flex",
    km: "52.000 km",
    price: "R$ 38.500",
  ...
  },
  {
    ...
    image: vehicleImage,
    badge: "Premium",
    tags: ["Único Dono", "Manual e Chave Reserva"],
  },
];
