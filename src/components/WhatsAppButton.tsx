...
Quero dar 30% do veículo e o restante em notas promissórias digitais.
Sem banco, sem financiamento e sem burocracia.

✅ EU QUERO APROVAR DAN CAR

✔️ Processo rápido
✔️ Assinatura digital simples
✔️ Compra segura entre comprador e vendedor
✔️ Tudo registrado pelo app DAN CAR
...
📲 Suporte 24H`);
  ...
  return <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 h-12 px-4 sm:h-14 sm:px-6 bg-[#25D366] hover:bg-[#20BA5A] rounded-full shadow-lg hover:shadow-xl flex items-center justify-center gap-2 transition-all duration-300 hover:scale-105 animate-pulse-glow" aria-label="Contato via WhatsApp">
